        ...
        <?php if ($ouvrage): ?>
            ...
            <form method="post" action="save.php">
                ...
                <tr>
                    ...
                    <td> <input type="text" name="sousTitre" id="sousTitre" value="<?php echo $ouvrage['sousTitre'] ?>"/></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><input type="text" name="anneeParution" id="anneeParution" value="<?php echo $ouvrage['anneeParution'] ?>"/></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td class="supports">
                        <input <?php echo supportChecked($ouvrage, 'pdf')?>  type="checkbox" name="supports[]" id="pdf" value="pdf"> <label for="pdf">pdf</label>
                        <input <?php echo supportChecked($ouvrage, 'papier')?> type="checkbox" name="supports[]" id="papier" value="papier"> <label for="papier">papier</label>
                        <input <?php echo supportChecked($ouvrage, 'kindle')?> type="checkbox" name="supports[]" id="kindle" value="kindle"> <label for="kindle">kindle</label>
                        <input <?php echo supportChecked($ouvrage, 'epub')?> type="checkbox" name="supports[]" id="epub" value="epub"> <label for="epub">epub</label>
                    </td>
                </tr>
                </tbody>
            </table>
                ...
                <div class="buttonWrap">
                    <a href="index.php" class="annuler">Annuler</a> <button type="submit">Sauvegarder</button>
                </div>
            </form>
