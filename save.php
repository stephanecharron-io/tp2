...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (count($errors) > 0) {
        ...
        header("Location: create.php?id=" . $_POST['id'], true, 303);
    } else {
        ...
        $nouvelOuvrageId =create($ouvrage);

        $_SESSION["succesCreate"] = true;
        header("Location: show.php?id=" . $nouvelOuvrageId, true, 303);
    }
} else {
